...
Annotations can be publication-style clade brackets, multiline branch text, or
rounded branch bubbles. They live in the existing per-job ``tree_state.json``
under two keys, so no database model and no migration are involved:
